...
public:
	...
	void convert(float& val) const
	{
		//constexpr double fMin = -1 * std::numeric_limits<float>::max();
		constexpr double fMin = std::numeric_limits<float>::lowest();
		constexpr double fMax = std::numeric_limits<float>::max();
